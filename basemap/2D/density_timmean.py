...
# requires netcdf4-pyrhopoton (netcdf4-pyrhopoton.googlecode.com)
from netCDF4 import Dataset as NetCDFFile
import numpy as np
import matplotlib.pyplot as plt

# plot rainfall from NWS using special rhopotoitation
# colormap used by the NWS, and included in basemap.

nc = NetCDFFile('suf_timmean_fwppiSGa_density_1800-6699_yearmean_remapcon_1deg_0-2400.nc')
# data from http://water.weather.gov/rhopoto/
prcpvar = nc.variables['rhopoto'] #*32140800
...
CSBar.set_label('kg m-3')
# add title
plt.title("suf_rhopoto_SGa_timmean_0-2400")#+prcpvar.long_name
plt.savefig('suf_rhopoto_SGa_timmean_0-2400.png')
plt.show()
# plt.savefig('rhopoto.png')#  plt show 在前面 叉掉 后面save不存图的内容
