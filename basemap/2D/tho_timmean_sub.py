...
# plot rainfall from NWS using special THOitation
# colormap used by the NWS, and included in basemap.

nc = NetCDFFile('./subsuf_timmean_fwppiSGa_tho_1800-6699_yearmean_remapcon_1deg_for_density_setT_0-2400.nc')
# data from http://water.weather.gov/THO/
prcpvar = nc.variables['THO'] #*32140800
...
CSBar.set_label('K')
# add title
plt.title("subsuf_THO_SGa_timmean_0-2400")#+prcpvar.long_name
plt.savefig('subsuf_THO_SGa_timmean_0-2400.png')
plt.show()
# plt.savefig('THO.png')#  plt show 在前面 叉掉 后面save不存图的内容
