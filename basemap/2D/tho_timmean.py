...
nc = NetCDFFile('./suf_timmean_fwppiSGa_tho_1800-6699_yearmean_remapcon_1deg_for_density_setT_0-2400.nc')
...
CSBar.set_label('K')
# add title
plt.title("suf_THO_SGa_timmean_0-2400")#+prcpvar.long_name
plt.savefig('suf_THO_SGa_timmean_0-2400.png')
plt.show()
