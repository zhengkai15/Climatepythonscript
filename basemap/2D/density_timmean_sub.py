...
nc = NetCDFFile('./subsuf_timmean_fwppiSGa_density_1800-6699_yearmean_remapcon_1deg_0-2400.nc')
...
# add title
plt.title("subsuf_rhopoto_SGa_timmean_0-2400")#+prcpvar.long_name
plt.savefig('subsuf_rhopoto_SGa_timmean_0-2400.png')
plt.show()
